...
const Stage = ({
  ...
  <div className="relative">
    ...
    <div className="flex flex-col justify-center items-center text-center w-full h-full absolute top-10 text-neutral-100 font-bold md:top-5 lg:-top-20 lg:-left-25">
